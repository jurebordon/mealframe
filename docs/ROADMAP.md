...
|---------|-----|--------|--------|
| AI-Powered Onboarding | ADR-015 | feat/ai-onboarding | In progress (Session 4) |
...
- [x] Session 3: AI setup generation — Claude Sonnet tool calling for meal types, templates, week plan [feature: ai-onboarding]
